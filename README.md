...
> ℹ️ **Note:** All information below is intended for use on Windows 11, though can be partially applied to Win10 as well.
...
<ul>
  <li>🌙 Disable Hibernation<br><i>(will also disable Fast Startup)</i></li>
